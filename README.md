...
Supabase
  ...
  SUPABASE_ANON_KEY (legacy, opcional)
  SUPABASE_SERVICE_ROLE_KEY (legacy, solo servidor)
...
IA
  ...
  OPENAI_*_USD_PER_MILLION (costes opcionales)

Voz
  ELEVENLABS_API_KEY
  ELEVENLABS_MODEL_ID
  ELEVENLABS_VOICE_ID (opcional)
  ELEVENLABS_USD_PER_1000_CHARS (opcional)
...
Aplicación
  PROGY_APP_URL
  NEXT_PUBLIC_PROGY_MAX_PAYLOAD_MB
  PROGY_UNLIMITED_VOICE_TESTS (solo local, opcional)
```
