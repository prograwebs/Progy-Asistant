...
import type { CatalogItem, SelectedWorkspace, WorkspaceAction } from "@/lib/shared/types/workspace";
import { businessBlueprint, money } from "@/lib/shared/utils/formatters";
