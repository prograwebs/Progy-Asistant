...
import { getOnboardingTemplate, TEMPLATE_VERSION } from "@/lib/shared/onboarding/templates";
import { getNicheProfile } from "../niche/profile";
import { initializeTrialPlan } from "../billing/quota";
import type { OnboardingActivationStatus, OnboardingChannelStatus, OnboardingFlowStatus, OnboardingReadiness, OnboardingSnapshot } from "@/lib/shared/types/onboarding";
